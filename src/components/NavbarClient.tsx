...
export default function NavbarClient({
  ...
  // Built from WordPress Site Settings — omit a link entirely rather than
  // rendering a dead/placeholder href when a field hasn't been filled in.
  const socialLinks = [
    instagramUrl && { href: instagramUrl, label: "Instagram", Icon: SiInstagram },
    facebookUrl && { href: facebookUrl, label: "Facebook", Icon: SiFacebook },
    whatsappPhone && {
    ...
    (link): link is { href: string; label: string; Icon: typeof SiInstagram } =>
      Boolean(link)
  );
