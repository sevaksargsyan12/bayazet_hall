...
export default function PackageCard({ pkg }: { pkg: Package }) {
  return (
    <div className="package-card h-full">
      <div
        className={`group relative flex h-full flex-col rounded-2xl border p-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-amber-300/60 dark:hover:shadow-amber-400/20 ${
          pkg.highlighted
      ...
      >
        ...
        <div className="mt-6 flex items-baseline gap-1">
          ...
          <span className="text-sm text-foreground/50">/ մեկ հոգու համար</span>
        </div>
